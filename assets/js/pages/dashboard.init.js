...
function(o) {
    ...
    t.prototype.initCharts = function() {
        var t = {
            ...
            series: [{
                data: [25, 66, 41, 85, 63, 25, 44, 12, 36, 9]
            }],
            stroke: {
                width: 2,
                curve: "smooth"
        ...
        new ApexCharts(document.querySelector("#total-sps"), t).render(), new ApexCharts(document.querySelector("#total-vehicles"), o.extend({}, t, {
            colors: ["#f77e53"]
        })).render(), new ApexCharts(document.querySelector("#total-drivers"), o.extend({}, t, {
            colors: ["#43d39e"]
        })).render(), new ApexCharts(document.querySelector("#total-passengers"), o.extend({}, t, {
            colors: ["#ffbe0b"]
        })).render();
        var e = new Date,
            r = {
